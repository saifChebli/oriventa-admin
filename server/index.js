...
// middlewares
app.use(cors({
    origin : ['http://localhost:5173', 'http://localhost:5174', "http://localhost:8080" ,'https://oriventa-pro-service.com' , 'https://oriventa-pro-service.tn' ,'https://landing.oriventa-pro-service.tn' ,'https://admin.oriventa-pro-service.tn'] ,
    credentials : true,
